              ...
              <div class="span12">
                <div id="rootwizard">
                  ...
                  <ul class="pager wizard">
                    ...
                    <li class="next finish" style="display:none;"><a href="javascript:void(0);">Finish</a></li>
                  </ul>
                </div>
              </div>
            </div>
  ...
  <script>
    ...
    $(function () {
      ...
      $('#rootwizard .finish').click(function () {
        ...
        var place_of_birth = $('#placeOfBirth').val();
        var nationality = $('#nationality').val();
        var gender = $('#gender').val();
        var status = $('#status').val();
        var contact_number = $('#contactNumber').val();
        var facebook_account = $('#fbAcc').val();
        ...
        var parent_name = $('#parentName').val();
        var parent_contact_number = $('#parentContactNumber').val();
        var parent_address = $('#parentAddress').val();
        var parent_occupation = $('#parentOccupation').val();
        var elementary_school = $('#elemSchool').val();
        var high_school = $('#highSchool').val();
