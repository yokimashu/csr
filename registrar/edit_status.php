                ...
                <fieldset>
                  ...
                  <div class="box-body">
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input type="text" class="form-control" name="year_level" value="<?php echo $teacher_id; ?>" required>
                      </div>
                    </div>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input type="text" class="form-control" name="total_students_number"  value="<?php echo $status; ?>" required>
                      </div>
                    </div>
