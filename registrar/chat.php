...
<div>
	<button id="chatButton" class="open-button" onclick="openForm();startChat()">Chat &nbsp
		<b style="font-size:16px;" class=" icon-comment" id="chatNotify"></b>
	</button>
</div>
...
<div class="chat-popup" id="myForm">
	...
	<div id="MainBody" style="bg-color:white;">
		<h3><b style="color:green">CSR</b> Chatbox</h3>
		...
		<script>
			...
			$("#chatNotify").load("../registrar/msgnotif.php");
		...
		<script>
			...
			function autoScrollVar() {
				...
				$("#chatHere").load("../registrar/message.php");
		...
		<input onkeyup="notEmptyText();" autocomplete="off" type="text" style="height:30px;width:fit-content; word-wrap: break-word;overflow:scroll;" placeholder="Type message.." name="msgMain" id="msgMain" class="form-control" value="">
		<br>
