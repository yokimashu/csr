...
insert  into `tbl_grades`(`idno`,`objid`,`students_id`,`subjects_id`,`descriptive_title`,`prelim`,`midterm`,`finals`,`remarks`) values (9,'1317','7625','ITC111','Introduction to Computing',85,90,0,'PASSED'),(10,'1317','7625','Filipino1','Komunikasyon sa Akademikong Fi',75,83,80,''),(11,'1317','7625','ITC112','Computer Programming 1',90,90,0,'');
